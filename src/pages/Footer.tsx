    ...
    return (
        <div className="lg:px-0 px-10  mt-[150px] w-full max-w-[880px] flex flex-col items-center text-white font-Clash">
            <div className="flex flex-col w-full items-center justify-center">
                ...
                <p className="text-clamp5 font-semibold tracking-tighter text-center">Wanna get in touch?</p>
            ...
            <div className="flex w-full text-clamp3  justify-between items-center pt-[10%]">
            ...
            <div className="text-[12px] select-none flex items-center justify-center gap-1 pt-[5%] pb-5">
                ...
                <div className="flex flex-col items-center text-[#696969] text-[15px]">
